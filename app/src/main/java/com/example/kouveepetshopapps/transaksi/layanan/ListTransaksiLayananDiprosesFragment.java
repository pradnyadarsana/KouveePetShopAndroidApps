...
public class ListTransaksiLayananDiprosesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerTransaksiLayanan = view.findViewById(R.id.recycler_view_transaksi_layanan_diproses);
        addTransaksiLayananBtn = view.findViewById(R.id.addTransaksiLayananDiprosesButton);
    ...
    public void setRecycleView(){
        ...
        Call<GetTransaksiLayanan> transaksiLayananDAOCall = apiService.getTransaksiLayananSedangDiproses();
        ...
        transaksiLayananDAOCall.enqueue(new Callback<GetTransaksiLayanan>() {
            ...
            public void onFailure(Call<GetTransaksiLayanan> call, Throwable t) {
                Toast.makeText(getContext(), "Gagal menampilkan transaksi layanan diproses", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
