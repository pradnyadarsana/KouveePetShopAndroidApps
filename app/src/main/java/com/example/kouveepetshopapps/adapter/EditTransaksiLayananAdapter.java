...
public class EditTransaksiLayananAdapter extends RecyclerView.Adapter<EditTransaksiLayananAdapter.MyViewHolder> {
    ...
    private ActivityEditTransaksiLayananBinding binding;
    private List<Integer> deleted_id_detail_transaksi;

    public EditTransaksiLayananAdapter(Context context, TransaksiLayananDAO transaksiLayanan,
                                         ...
                                         ActivityEditTransaksiLayananBinding binding, List<Integer> deleted_id_detail_transaksi){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.adapter_edit_transaksi_layanan, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(@NonNull View itemView){
            super(itemView);
            harga_layanan = itemView.findViewById(R.id.tvHargaLayananEditTransaksiLayanan);
            jumlah_layanan = itemView.findViewById(R.id.tvJumlahEditTransaksiLayanan);
            total_harga = itemView.findViewById(R.id.tvTotalHargaEditTransaksiLayanan);
            kurang_produk = itemView.findViewById(R.id.btnKurangJumlahEditTransaksiLayanan);
            tambah_produk = itemView.findViewById(R.id.btnTambahJumlahEditTransaksiLayanan);
            parent = itemView.findViewById(R.id.ParentEditItemTransaksiLayanan);

            //create Autocompletetextview for nama hewan
            nama_harga_layanan = (AutoCompleteTextView) itemView.findViewById(R.id.etNamaLayananEditTransaksiLayanan);
...
//                    (context, android.R.layout.select_dialog_item, arrName);
    ...
    public void delete(int position) { //removes the row
        deleted_id_detail_transaksi.add(result.get(position).getId_detail_transaksi_layanan());
