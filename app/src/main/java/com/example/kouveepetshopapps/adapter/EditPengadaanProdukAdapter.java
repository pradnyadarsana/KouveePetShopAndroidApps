...
public class EditPengadaanProdukAdapter extends RecyclerView.Adapter<EditPengadaanProdukAdapter.MyViewHolder> {
    ...
    private ActivityEditPengadaanProdukBinding binding;
    private List<Integer> deleted_id_detail_pengadaan;

    public EditPengadaanProdukAdapter(Context context, PengadaanProdukDAO pengadaanProduk,
                                      List<DetailPengadaanDAO> result, List<ProdukDAO> produk,
                                      List<ProdukDAO> produkPilihan, ActivityEditPengadaanProdukBinding binding,
                                      List<Integer> deleted_id_detail_pengadaan){
        ...
        this.deleted_id_detail_pengadaan = deleted_id_detail_pengadaan;
    }

    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.adapter_edit_pengadaan_produk, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        if(produkPilihan.get(position)!=null){
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(@NonNull View itemView){
            super(itemView);
            harga_produk = itemView.findViewById(R.id.etHargaProdukEditPengadaan);
            jumlah_produk = itemView.findViewById(R.id.tvJumlahProdukEditPengadaan);
            total_harga = itemView.findViewById(R.id.tvTotalHargaEditPengadaan);
            kurang_produk = itemView.findViewById(R.id.btnKurangJumlahProdukEditPengadaan);
            tambah_produk = itemView.findViewById(R.id.btnTambahJumlahProdukEditPengadaan);
            parent = itemView.findViewById(R.id.ParentEditItemPengadaanProduk);

            //create Autocompletetextview for nama hewan
            nama_produk = (AutoCompleteTextView) itemView.findViewById(R.id.etNamaProdukEditPengadaan);
            ...
            nama_produk.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    if(produk!=null){
                        ...
                        int total = result.get(getAdapterPosition()).getHarga()*result.get(getAdapterPosition()).getJumlah();
                        result.get(getAdapterPosition()).setTotal_harga(total);
                        harga_produk.setText(String.valueOf(result.get(getAdapterPosition()).getHarga()));
                        total_harga.setText(String.valueOf(total));
    ...
    public void delete(int position) { //removes the row
        deleted_id_detail_pengadaan.add(result.get(position).getId_detail_pengadaan());
