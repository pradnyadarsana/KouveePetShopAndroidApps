...
public class EditTransaksiProdukAdapter extends RecyclerView.Adapter<EditTransaksiProdukAdapter.MyViewHolder> {
    ...
    private ActivityEditTransaksiProdukBinding binding;
    private List<Integer> deleted_id_detail_transaksi;

    public EditTransaksiProdukAdapter(Context context, TransaksiProdukDAO transaksiProduk,
                                      List<DetailTransaksiProdukDAO> result, List<ProdukDAO> produk,
                                      List<ProdukDAO> produkPilihan, ActivityEditTransaksiProdukBinding binding,
                                      List<Integer> deleted_id_detail_transaksi){
        ...
        this.deleted_id_detail_transaksi = deleted_id_detail_transaksi;
    }

    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.adapter_edit_transaksi_produk, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(@NonNull View itemView){
            super(itemView);
            harga_produk = itemView.findViewById(R.id.tvHargaProdukEditTransaksiProduk);
            jumlah_produk = itemView.findViewById(R.id.tvJumlahEditTransaksiProduk);
            total_harga = itemView.findViewById(R.id.tvTotalHargaEditTransaksiProduk);
            kurang_produk = itemView.findViewById(R.id.btnKurangJumlahEditTransaksiProduk);
            tambah_produk = itemView.findViewById(R.id.btnTambahJumlahEditTransaksiProduk);
            parent = itemView.findViewById(R.id.ParentEditItemTransaksiProduk);

            //create Autocompletetextview for nama hewan
            nama_produk = (AutoCompleteTextView) itemView.findViewById(R.id.etNamaProdukEditTransaksiProduk);
    ...
    public void delete(int position) { //removes the row
        deleted_id_detail_transaksi.add(result.get(position).getId_detail_transaksi_produk());
